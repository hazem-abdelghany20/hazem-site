...
export const THREADS: { key: ThreadKey; ar: string; en: string; blurb: string }[] = [
  { key: 'building', ar: 'البناء', en: 'Building', blurb: 'Companies, products, and the systems behind them.' },
  { key: 'faith', ar: 'الإيمان', en: 'Faith', blurb: 'The anchor everything else hangs on.' },
  { key: 'body', ar: 'الجسد', en: 'Body', blurb: 'Training, food, recovery — and rebuilding a knee.' },
